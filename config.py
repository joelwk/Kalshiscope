...
class Settings:
    ...
    FALLBACK_EDGE_MIN_EDGE: float = 0.26
    ...
    GROK_STREAM_TIMEOUT_SECONDS: int = 90
    ...
    SCORE_GATE_THRESHOLD: float = 0.48
    SCORE_GATE_THRESHOLD_WEATHER_DIRECT: float = 0.12
    SCORE_GATE_THRESHOLD_DIRECT_HIGH_QUALITY: float = 0.22
    ...
    DIRECT_SOURCE_MIN_EVIDENCE_QUALITY_DEFAULT: float = 0.68
    ...
    MAX_LIFETIME_ANALYSES_PER_MARKET: int = 12
    ...
    HISTORICAL_TICKER_PREFIX_PNL_CUTOFF: float = -3.0
    ...
    HISTORICAL_TICKER_PREFIX_HARD_BLOCK_MIN_SAMPLES: int = 10
    ...
    DEFINITIVE_OUTCOME_EDGE_REASONABLE_MAX: float = 0.85
...
def load_settings() -> Settings:
    ...
    settings = Settings(
        ...
        PRE_ANALYSIS_ZERO_ACTION_FAMILY_USE_DEEP_ANALYZED_DENOMINATOR=_read_env_bool(
            "PRE_ANALYSIS_ZERO_ACTION_FAMILY_USE_DEEP_ANALYZED_DENOMINATOR",
            Settings.PRE_ANALYSIS_ZERO_ACTION_FAMILY_USE_DEEP_ANALYZED_DENOMINATOR,
        ),
        PRE_ANALYSIS_ZERO_ACTION_FAMILY_FORCE_PROBE_PER_DAY=_read_env_int(
            "PRE_ANALYSIS_ZERO_ACTION_FAMILY_FORCE_PROBE_PER_DAY",
            Settings.PRE_ANALYSIS_ZERO_ACTION_FAMILY_FORCE_PROBE_PER_DAY,
        ),
