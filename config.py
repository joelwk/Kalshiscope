...
class Settings:
    ...
    SCORE_GATE_THRESHOLD_DIRECT_HIGH_QUALITY: float = 0.25
    ...
    PRE_ANALYSIS_NON_ACTIONABLE_STREAK_PENALTY: float = 0.15
    PRE_ANALYSIS_NON_ACTIONABLE_STREAK_CAP: int = 8
    PRE_ANALYSIS_ANALYSIS_COUNT_PENALTY: float = 0.05
    ...
    CONFIDENCE_SHRINKAGE_FACTOR: float = 0.40
